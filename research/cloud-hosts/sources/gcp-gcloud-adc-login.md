...
You can create the client ID file at https://console.cloud.google.com/apis/credentials.
...
workforce-pools create-login-config). Overrides the default
...
scopes are used. The list of possible scopes can be found at: https://developers.google.com/identity/protocols/googlescopes.
To add scopes for applications outside of Google Cloud Platform, such as Google
Drive, create an OAuth
Client ID and provide it by using the --client-id-file flag.
