---
layout: Conceptual
title: How to configure Azure OpenAI in Microsoft Foundry Models with Microsoft Entra ID authentication (classic) - Microsoft Foundry (classic) portal | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/managed-identity
...
locale: en-us
document_id: 31d62c01-07f7-68f9-9a00-aaa4db6cf73b
document_version_independent_id: c66152cd-59a1-9c44-8607-24a75a8fe31c
updated_at: 2026-08-04T17:12:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/azure-ai-docs-pr/blob/live/articles/foundry-classic/openai/how-to/managed-identity.md
gitcommit: https://github.com/MicrosoftDocs/azure-ai-docs-pr/blob/13ec93a8c3edd2cef0dd7bac4417d6d660851301/articles/foundry-classic/openai/how-to/managed-identity.md
git_commit_id: 13ec93a8c3edd2cef0dd7bac4417d6d660851301
site_name: Docs
depot_name: Learn.azure-ai
page_type: conceptual
toc_rel: ../../toc.json
word_count: 1467
asset_id: foundry-classic/openai/how-to/managed-identity
moniker_range_name:
monikers: []
item_type: Content
source_path: articles/foundry-classic/openai/how-to/managed-identity.md
cmProducts:
...
platformId: 83bbe694-5080-9af1-c101-b2cfa0dcd958
---
...
- An Azure OpenAI resource with a [custom subdomain name](../../../ai-services/cognitive-services-custom-subdomains). You need a custom subdomain for Microsoft Entra ID authentication.
- A model deployed to your resource.
- Azure CLI - [Installation Guide](/en-us/cli/azure/install-azure-cli)
...
Role assignments control who can call your resource. Assign yourself either the [Cognitive Services OpenAI User](role-based-access-control#cognitive-services-openai-user) or [Cognitive Services OpenAI Contributor](role-based-access-control#cognitive-services-openai-contributor) role on the Azure OpenAI resource. Either role lets you make inference API calls with your own identity instead of a key.
...
1. Enable a managed identity on the Azure resource that hosts your app. For a virtual machine, see the quickstart for your preferred tool: [Azure portal](/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm), [Azure PowerShell](/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-powershell-windows-vm), [Azure CLI](/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-cli-windows-vm), [Azure Resource Manager template](/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-template-windows-vm), or [Azure Resource Manager client libraries](/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-sdk-windows-vm).
2. Assign the managed identity the **Cognitive Services OpenAI User** role on your Azure OpenAI resource, the same way you did for your own account in Assign a role.

### Use a system-assigned managed identity

If the host has only a system-assigned managed identity, the sample from Authenticate from your development machine works without any changes. `DefaultAzureCredential` finds the managed identity automatically when it runs in Azure.
...
For more information, see [Managed identities for Azure resources](/en-us/azure/active-directory/managed-identities-azure-resources/overview).
...
Control plane calls need a role that grants management permissions, such as **Cognitive Services Contributor**. The inference roles in Assign a role don't grant control plane access.

## Troubleshoot authentication errors

| Symptom | Likely cause | Fix |
| --- | --- | --- |
| `401 Unauthorized` | The resource doesn't have a custom subdomain, so it can't accept Entra tokens. | Configure a [custom subdomain](../../../ai-services/cognitive-services-custom-subdomains) and use the `https://YOUR-RESOURCE-NAME.openai.azure.com` endpoint rather than the regional endpoint. |
