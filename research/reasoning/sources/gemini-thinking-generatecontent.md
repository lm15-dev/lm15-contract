...
[models with thinking support](https://ai.google.dev/gemini-api/docs/generate-content/thinking#supported-models) in the `model` field, as
...
| Thinking Level | Gemini 3.7 Flash | Gemini 3.6 \& 3.5 Flash | Gemini 3.1 Pro | Gemini 3.5 \& 3.1 Flash-Lite | Gemini 3.1 Flash-Lite Image | Gemini 3 Flash | Description |
|---|---|---|---|---|---|---|---|
| **`minimal`** | Not supported (error) | Supported | Not supported | Supported (Default) | Supported (Default) | Supported | Matches the "no thinking" setting for most queries. Note, `minimal` does not guarantee that thinking is off, the model may reason very minimally for complex tasks. |
| **`low`** | Supported | Supported | Supported | Supported | Not Supported | Supported | Minimizes latency and cost. |
| **`medium`** | Supported (Default) | Supported (Default) | Supported | Supported | Not supported | Supported | Balanced thinking for most tasks. |
| **`high`** | Supported (Dynamic) | Supported (Dynamic) | Supported (Default, Dynamic) | Supported (Dynamic) | Supported (Dynamic) | Supported (Default, Dynamic) | Maximizes reasoning depth. The model may take significantly longer to reach a first (non thinking) output token, but the output will be more carefully reasoned. |
...
response, and then output [summaries](https://ai.google.dev/gemini-api/docs/generate-content/thinking#summaries) to provide insight into the
...
- **Provide Guidance in Reasoning** : If you're hoping for a particularly lengthy
  ...
  [amount of thinking](https://ai.google.dev/gemini-api/docs/generate-content/thinking#set-budget) the model uses. This lets you reserve more
